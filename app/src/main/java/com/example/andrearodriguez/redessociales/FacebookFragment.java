...
import static com.example.andrearodriguez.redessociales.R.drawable.ic_news;
...
public class FacebookFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < tabLayout.getTabCount(); i++) {
            ...
            switch (i) {
                case 0:
                    icon = ContextCompat.getDrawable(getContext(), ic_news);
                    break;
                case 1:
                    icon = ContextCompat.getDrawable(getContext(), R.drawable.ic_solicitudes);
                    break;
                case 2:
                    icon = ContextCompat.getDrawable(getContext(), R.drawable.ic_mundo);
                    break;
            }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
            ...
            activity.updateView(getString(R.string.redes), (getString(R.string.facebook)), 1);
