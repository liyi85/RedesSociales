...
public class TwitterFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new TwitterFragment.TwitterViewPagerAdapter(getActivity().getSupportFragmentManager()));
        ...
        for (int i = 0; i < tabLayout.getTabCount(); i++) {
            ...
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    icon = ContextCompat.getDrawable(getContext(), R.drawable.ic_message);
                    break;
                case 2:
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
            ...
            activity.updateView(getString(R.string.redes), (getString(R.string.twitter)), 4);
            activity.navigationView.setCheckedItem(R.id.nav_twitter);

    }
    private class TwitterViewPagerAdapter extends BaseViewPagerAdapter {

        public TwitterViewPagerAdapter(FragmentManager manager) {
            super(manager, tabs);
        }
    }
}
